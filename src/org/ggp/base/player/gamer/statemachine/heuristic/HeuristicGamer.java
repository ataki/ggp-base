...
public class HeuristicGamer extends StateMachineGamer
{
                          ...
                          GoalDefinitionException
    {
        ...
        for (Move prospect: moves) {
            ...
            int score = minScore(getCurrentState(), prospect, Integer.MIN_VALUE, Integer.MAX_VALUE, 0);
    ...
    private int maxScore(MachineState state, int alpha, int beta, int level)
        throws TransitionDefinitionException, MoveDefinitionException,
                          GoalDefinitionException
    {
        ...
        for (Move prospect : moves) {
            ...
            int score = minScore(state, prospect, alpha, beta, level);
    ...
    private int minScore(MachineState state, Move playerAction, int alpha, int beta, int level) 
        throws TransitionDefinitionException, MoveDefinitionException,
                          GoalDefinitionException
    {
