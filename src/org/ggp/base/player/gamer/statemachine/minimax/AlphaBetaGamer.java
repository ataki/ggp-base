...
public class AlphaBetaGamer extends StateMachineGamer
{
	...
	public Move stateMachineSelectMove(long timeout) throws TransitionDefinitionException, MoveDefinitionException, GoalDefinitionException
	{
        ...
        for (Move prospect: moves) {
            ...
            int score = minScore(getCurrentState(), prospect, Integer.MIN_VALUE, Integer.MAX_VALUE);
						  ...
						  GoalDefinitionException
    {
        ...
        for (Move prospect: moves) {
            ...
            int score = minScore(state, prospect, alpha, beta);
	...
	private int  minScore(MachineState state, Move playerAction, int alpha,
			int beta) throws TransitionDefinitionException,
			MoveDefinitionException, GoalDefinitionException
    {
        ...
        for (Move prospect: moves) {
            ...
            int score =
				maxScore(getStateMachine().getNextState(state,curMoves), alpha, beta);
