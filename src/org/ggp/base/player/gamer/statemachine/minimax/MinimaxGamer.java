...
public class MinimaxGamer extends StateMachineGamer
{
						  ...
						  GoalDefinitionException
	{
        ...
        for (Move prospect: moves) {
            ...
            int score = minScore(getCurrentState(), prospect);
    ...
    private int  maxScore(MachineState state)
		throws TransitionDefinitionException, MoveDefinitionException,
						  GoalDefinitionException
    {
        ...
        for (Move prospect: moves) {
            ...
            int score = minScore(state, prospect);
	...
	private int  minScore(MachineState state, Move playerAction) 
		throws TransitionDefinitionException, MoveDefinitionException,
						  GoalDefinitionException
    {
        ...
        for (Move prospect: moves) {
            ...
            int score =
				maxScore(getStateMachine().getNextState(state,curMoves));
